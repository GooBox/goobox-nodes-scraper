...
class TestResolveGeolocationPipeline:
    ...
    def test_init_download_file_with_invalid_content(self):
        ...
        with patch("core.pipelines.resolve_geolocation.urllib.request.urlretrieve"), patch(
            "core.pipelines.resolve_geolocation.tarfile.open", return_value=tarfile_mock
    ...
    def test_process_item_drop_name_not_resolve(self, item, pipeline, spider):
        ...
        with patch(
            "core.pipelines.resolve_geolocation.socket.gethostbyname", side_effect=socket.gaierror
